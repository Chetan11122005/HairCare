...
struct ContentView: View {
    ...
    var body: some View {
        ...
        .onAppear {
            if authVM.isLoggedIn,
               let userIdString = authVM.currentUserId,
        ...
        .onChange(of: authVM.isLoading) { _, isLoading in
            ...
            if authVM.isLoggedIn {
                ...
                store.createUser(
                    ...
                    authProvider: authVM.authProvider,
    ...
    private func handleGuestUpgrade(newUserId: UUID, name: String, email: String) {
        ...
        store.migrateGuestData(toUserId: newUserId, name: name, email: email, authProvider: authVM.authProvider)
